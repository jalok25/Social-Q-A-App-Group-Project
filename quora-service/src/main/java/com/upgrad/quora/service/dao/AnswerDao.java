...
public class AnswerDao {
    ...
    public List getAllAnswersToQuestion(String questionId) {
        try {
            return entityManager.createNamedQuery("getAllAnswerToQuestion").setParameter("question", questionId).getResultList();
        }
        catch (NoResultException nre){
            return  null;
        }
