...
public class AnswerBusinessService {
    ...
    @Transactional
    public AnswerEntity createAnswer(String answerContent, String authorization, String questionUuid) throws InvalidQuestionException, AuthorizationFailedException {
    ...
    public List<AnswerEntity> getAllAnswersToQuestion(String questionId, String authorization) throws AuthorizationFailedException, InvalidQuestionException {
        ...
        /*Check if the question to be edited Exists in the database
        If the question doesn't exist, throw the InvalidQuestionException*/
        boolean questionExists = questionDao.checkQuestionExistence(questionId);
        if(questionExists == false) {
